  ...
  return (
    ...
    <main>
        ...
        <p className="primary-color mb-[8px] md:mb-[16px] text-xl md:text-2xl">About us</p>
          <h1>A world-class law firm fuelled by excellence, creativity and professionalism, we are built to provide best-in-class legal services to our clients.</h1>
        </section>
        <section className="grid grid-cols-1 bg-light px-[24px] py-[80px] md:px-[117px] md:py-[160px]">
          <div className="col-span-1 md:pe-[32px] mb-[40px]">
            ...
            <span className={"primary-color " + styles.h2}>At Danol Partners, we epitomize unwavering dedication to legal principles, allegiance to our team members, and a steadfast </span>
            <span className={"gray-color " + styles.h2}>commitment to those who rely on our expertise. Danol Partners represents not only a commitment but also an ambitious goal that steers our relentless journey toward excellence.</span>
          </div>
        </section>
        <div style={{
